...
<link rel="icon" href="img/monitors.png">
<!-- Jquery Bootstrap js 
...
<title>网页信息</title>
<style type="text/css">
.dkbj {background-color:#f6f6f6;}
.dtbj {background-color:#c4dbb4;}
.opt{height:30px;line-height:24px}
.rdopt{display:inline-block;color:green;}
.container {width:970px;}
.mymargin_left{margin-left:10px;}
</style>
</head>
<body>
<div class="container">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/locales/bootstrap-datepicker.zh-CN.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/bootstrap-table.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/locales/bootstrap-table-zh-CN.js"></script>
